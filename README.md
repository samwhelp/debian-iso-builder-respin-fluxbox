...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-respin-fluxbox/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-respin-fluxbox/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-respin-fluxbox/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-respin-fluxbox](https://github.com/samwhelp/debian-iso-builder-respin-fluxbox)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-respin-fluxbox.git
```


> change dir to `debian-iso-builder-respin-fluxbox`

``` sh
cd debian-iso-builder-respin-fluxbox
```
...
> The resulting ISO file will be placed on `debian-iso-builder-remix-fluxbox/dist`
...
| [debian-iso-builder-remix-xfce](https://github.com/samwhelp/debian-iso-builder-remix-xfce) | [debian-iso-builder-respin-fluxbox](https://github.com/samwhelp/debian-iso-builder-respin-xfce) |
